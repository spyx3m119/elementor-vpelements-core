<?php
namespace Elementor_VPElements;
...
final class Plugin {
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'elementor-vpelements' ),
			'<strong>' . esc_html__( 'VPElements', 'elementor-vpelements' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'elementor-vpelements' ) . '</strong>',
	...
	// 	require_once( __DIR__ . '\controls\list.php' );
	// 	require_once( __DIR__ . '\controls\template.php' );
